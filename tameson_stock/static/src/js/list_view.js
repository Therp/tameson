    ...
    FormController.include({
      renderButtons: function ($node) {
        ...
        if (this.$buttons) {
          this.$buttons.on(
            "click",
            ".batch-picking-ups-labels",
            this.batch_picking_ups_labels.bind(this)
          );
          this.$buttons.on(
            "click",
            ".batch-picking-delivery-labels",
            this.batch_picking_delivery_labels.bind(this)
          );
        }
        return ret;
      },
      ...
      renderButtons: function ($node) {
        ...
        if (this.$buttons) {
          this.$buttons.on(
            "click",
            ".picking-ups-labels",
            this.proxy("picking_ups_labels")
          );
          this.$buttons.on(
            "click",
            ".picking-delivery-labels",
            this.proxy("picking_delivery_labels")
          );
        }
        return ret;
      },
