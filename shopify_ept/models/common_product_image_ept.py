...
class ProductImageEpt(models.Model):
    ...
    def create(self, vals):
        ...
        if vals.get("product_id", False):
            ...
            for shopify_variant in shopify_variants:
                shopify_product_image_vals.update(
                    {
                        "shopify_variant_id": shopify_variant["id"],
                        "shopify_template_id": shopify_variant["shopify_template_id"][
                            0
                        ],
                        "sequence": 0,
                    }
    ...
    def write(self, vals):
        ...
        for record in self:
            shopify_product_images += shopify_product_images.search(
