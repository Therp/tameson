...
class StockPicking(models.Model):
    ...
    def action_done(self):
        ...
        for picking in self:
            ...
            work_flow_process_record = (
                picking.sale_id and picking.sale_id.auto_workflow_process_id
            )
            if (
                work_flow_process_record
                and picking.mapped("move_line_ids").filtered(
    ...
    def get_set_product(self, product):
        ...
        try:
            ...
            bom_point = bom_obj.sudo()._bom_find(product=product, bom_type="phantom")
            lines = []
            if bom_point:
