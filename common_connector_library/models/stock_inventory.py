...
class StockInventory(models.Model):
    ...
    def create_stock_inventory(self, products, location_id, auto_validate=False):
        ...
        """
        if products:
            inventory_name = "product_inventory_%s" % (
    ...
    def create_inventory_lines(self, products, location_id):
        ...
        for product_data in products:
            if product_data.get("product_id", False) and product_data.get(
                "product_qty", False
            ):
                val = self.prepare_inventory_line_vals(
    ...
    def prepare_inventory_line_vals(self, product, qty, location):
        ...
        vals = {
            ...
            "theoretical_qty": product_obj.get_theoretical_quantity(
