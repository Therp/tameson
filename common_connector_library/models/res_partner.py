...
class ResPartner(models.Model):
    ...
    def create_order_update_state(
        self, country_code, state_name_or_code, zip_code, country_obj=False
    ):
        """
                ...
                state = state_obj.search(
                    [
                        ...
                        (
                            "code",
                            "=",
                            response.get("places")[0].get("state abbreviation"),
                        ),
                        ("country_id", "=", country.id),
                    ],
                    limit=1,
