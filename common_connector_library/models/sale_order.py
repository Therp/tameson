...
class SaleOrder(models.Model):
    ...
    def _get_move_count(self):
        ...
        stock_moves = stock_move_obj.search(
            [("picking_id", "=", False), ("sale_line_id", "in", self.order_line.ids)]
        )
    ...
    def onchange_partner_shipping_id(self):
        ...
        if self.warehouse_id:
            ...
            origin_country_id = (
                ...
                and warehouse.partner_id.country_id
                and warehouse.partner_id.country_id.id
                or False
            )
            origin_country_id = origin_country_id or (
                warehouse.company_id.partner_id.country_id
                and warehouse.company_id.partner_id.country_id.id
                or False
            )
            ...
            context.update(
                is_amazon_fpos=is_amz_customer,
                is_bol_fiscal_position=is_bol_customer,
