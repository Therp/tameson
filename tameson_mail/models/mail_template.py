...
class IrMailServer(models.Model):
    ...
    def build_email(self, email_from, email_to, subject, body, email_cc=None, email_bcc=None, reply_to=False,
        ...
        if object_id and 'partner_id' in object_id:
            ...
            if object_id.partner_id and object_id.partner_id.lang and object_id.partner_id.lang:
                ...
                country_specific_email_from = self.env['ir.translation']._get_source(name='email', types='model', lang=lang, source=company.email, res_id=company)
